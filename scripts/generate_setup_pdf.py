...
def footer(canvas, doc):
    ...
    canvas.drawString(doc.leftMargin, 0.30 * inch, "AUTOBOT Owned-Event RSVP Lab v0.13.1")
...
def build_pdf():
    ...
    doc = SimpleDocTemplate(
        ...
        title="AUTOBOT v0.13.1 Second Computer Setup",
    ...
    story.append(Paragraph("AUTOBOT v0.13.1", title))
    ...
    item("Extract the ZIP. Open the folder named AUTOBOT-System-v0.13.1.")
    callout(
    ...
    p("In File Explorer, open AUTOBOT-System-v0.13.1. Click the address bar, type <b>powershell</b>, and press Enter.")
    ...
    item("Confirm AUTOBOT Owned-Event RSVP Lab v0.13.1 appears.")
    ...
    p("Type <font name='Courier'>cd</font> followed by one space. Drag the extracted AUTOBOT-System-v0.13.1 folder into Terminal, then press Return.")
    ...
    callout(
        ...
        "AUTOBOT v0.13.1 recognizes it as confirmed without choosing either marketing option."
    )
