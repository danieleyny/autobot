...
def footer(canvas, doc):
    ...
    canvas.drawString(doc.leftMargin, 0.30 * inch, "AUTOBOT Owned-Event RSVP Lab v0.13.2")
...
def build_pdf():
    ...
    doc = SimpleDocTemplate(
        ...
        title="AUTOBOT v0.13.2 Second Computer Setup",
    ...
    story.append(Paragraph("AUTOBOT v0.13.2", title))
    ...
    item("Extract the ZIP. Open the folder named AUTOBOT-System-v0.13.2.")
    callout(
    ...
    p("In File Explorer, open AUTOBOT-System-v0.13.2. Click the address bar, type <b>powershell</b>, and press Enter.")
    ...
    item("Confirm AUTOBOT Owned-Event RSVP Lab v0.13.2 appears.")
    ...
    p("Type <font name='Courier'>cd</font> followed by one space. Drag the extracted AUTOBOT-System-v0.13.2 folder into Terminal, then press Return.")
    ...
    operating_item("Complete the ownership and written-permission confirmations, run the fresh system check, lock the configuration, then click <b>Prepare + activate</b> at least two minutes before release.")
    ...
    callout(
        ...
        "AUTOBOT v0.13.2 recognizes it as confirmed without choosing either marketing option."
    )
    ...
    operating_item("If one laptop is slower, use <b>Copy local performance report</b> in its AUTOBOT panel. The report stays on that laptop and contains no login or password data.")
